        ...
        <div id="page-wrapper">
            <div class="row">
              ...
              <ul class="nav nav-tabs">
                <li role="presentation" ><a href="{{route('student_main')}}">CAS</a></li>
                <li role="presentation" ><a href="{{route('student_main_second')}}">CCJE</a></li>
                <li role="presentation" ><a href="{{route('student_main_third')}}">CBA</a></li>
                <li role="presentation" ><a href="{{route('student_main_fourth')}}">CED</a></li>
                <li role="presentation" class="active"><a href="{{route('student_main_fifth')}}">CIT</a></li>
              </ul>
