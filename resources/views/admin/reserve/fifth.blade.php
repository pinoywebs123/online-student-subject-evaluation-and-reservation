        ...
        <div id="page-wrapper">
          <div class="row">
            <ul class="nav nav-tabs">
              <li role="presentation" ><a href="{{route('admin_reserve')}}">CAS</a></li>
              <li role="presentation" ><a href="{{route('admin_reserve_second')}}">CCJE</a></li>
              <li role="presentation" ><a href="{{route('admin_reserve_third')}}">CBA</a></li>
              <li role="presentation"><a href="{{route('admin_reserve_fourth')}}">CED</a></li>
              <li role="presentation" class="active"><a href="{{route('admin_reserve_fifth')}}">CIT</a></li>
            </ul>
