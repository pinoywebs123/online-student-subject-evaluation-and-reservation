        ...
        <div id="page-wrapper">
          <div class="row">
           ...
           <div class="col-md-3">
            ...
            @endif
            @if($find->subject_payment)
              <div class="panel panel-primary">
                <div class="panel-heading">
                  <span class="glyphicon glyphicon-education"></span> 
                  <i class="pull-right" id="countStudents">{{$counts}}</i>
                </div>
                <div class="panel-body">
                 Subject Total Payment:  P{{$find->subject_payment->total_payment}}
                </div>
                <div class="panel-footer">
                  <a href="{{route('notify_all',['id'=> $find->id])}}" class="btn btn-warning btn-xs">SEND SMS
            ...
            @else
             <div class="panel panel-primary">
                ...
                <div class="panel-body">
                <form action="{{route('subject_tuition', ['id'=> $find->id])}}" method="POST">
