...
<body>
        ...
        <div id="page-wrapper">
          <div class="row">
            <ul class="nav nav-tabs">
              ...
              <li role="presentation" class="active"><a href="{{route('admin_students_create')}}">Create</a></li>
              
            </ul>


           <div>
            <form action="{{route('admin_students_create_check')}}" method="POST">
                <div class="col-md-6">
    ...
    <script type="text/javascript">
       @if(Session::has('suc'))
              swal("Congratulations! ", "New Student has been added Successfully!", "success");
        @endif
  </script>
