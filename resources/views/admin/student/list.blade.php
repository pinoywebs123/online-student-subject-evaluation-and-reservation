                  ...
                  @foreach($students as $student)
                    <tr>
                      ...
                      <td>
                        ...
                        @else
                        <form action="{{route('admin_disable_user', ['user_id'=> $student->id])}}" id="{{$student->id}}" method="POST">
                          <button type="button" class="btn btn-warning btn-xs" value="{{$student->id}}"><i class="glyphicon glyphicon-lock" ></i></button>
                          {{csrf_field()}}
                        </form>

                         <!--  <a href="{{route('admin_disable_user', ['user_id'=> $student->id])}}" class="btn btn-warning btn-xs"><i class="glyphicon glyphicon-lock"></i></a> -->
                        @endif
