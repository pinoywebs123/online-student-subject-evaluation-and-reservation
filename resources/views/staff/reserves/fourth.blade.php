        ...
        <div id="page-wrapper">
            <div class="row">
              ...
              <ul class="nav nav-tabs">
                ...
                <li role="presentation"><a href="{{route('staff_second')}}">Second Year</a></li>
                <li role="presentation" ><a href="{{route('staff_third')}}">Third Year</a></li>
                <li role="presentation" class="active"><a href="{{route('staff_fourth')}}">Fourth Year</a></li>
