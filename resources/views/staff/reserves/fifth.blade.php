        ...
        <div id="page-wrapper">
            <div class="row">
              ...
              <ul class="nav nav-tabs">
                <li role="presentation" ><a href="{{route('staff_main')}}">CAS</a></li>
                <li role="presentation"><a href="{{route('staff_second')}}">CCJE</a></li>
                <li role="presentation"><a href="{{route('staff_third')}}">CBA</a></li>
                <li role="presentation" ><a href="{{route('staff_fourth')}}">CED</a></li>
                <li role="presentation" class="active"><a href="{{route('staff_fifth')}}">CIT</a></li>
              </ul>


              @if($fifth->count())
                  @foreach($fifth as $subject)
                      <a href="#">
                    <div class="col-sm-6 col-md-3">
                        <div class="thumbnail hovereffect">
                          ...
                          <div class="caption">
                            ...
                            <div class="overlay">
                             <h2></h2>
                             <a class="info" href="{{route('view_student_list', ['id'=> $subject->id])}}">View More</a>
                          </div>
