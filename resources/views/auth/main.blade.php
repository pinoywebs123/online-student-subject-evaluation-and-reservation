...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#">NORSU BCC</a>
    </div>
...
<div class="container">
	<h1 class="text-center">NORSU BCC Enrollment Inquiry and Reservation</h1>
	@if($subjects->count())
						...
						<div class="col-sm-6 col-md-3">
						    <div class="thumbnail hovereffect">
						      ...
						      <div class="caption">
						       ...
						       <p><small>Teacher Here</small></p>
						       <span class="badge">Number of reserve students</span>
						      </div>
						    </div>
						 </div>
